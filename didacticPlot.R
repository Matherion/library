...
###########################################################
###
### Function to create a didactic plot with coloured areas
### showing the probabilities (p-values).
###
### File created by Gjalt-Jorn Peters. Questions? You can
### contact me through http://behaviorchange.eu.
###
### Note: curves based on
### http://codealamode.blogspot.nl/2012/04/density-plots-and-histograms-in-ggplot2.html
###
###########################################################
###########################################################
...
### Contains distribution of Pearson r
...
didacticPlot <- function(foundValue, statistic, df1, df2 = NULL,
  ...
  ### Generate basic plot
  res$plot.basic <- ggplot(dat=res$plotData, aes(x=x, y=y, x.lo=x.lo, x.hi=x.hi)) +
